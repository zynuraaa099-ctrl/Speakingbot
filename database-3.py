...
# DB_PATH muhit o'zgaruvchisi orqali sozlanadi — Railway'da doimiy diskka
# (Volume) ulanganda shu yo'lni ko'rsatish kerak, aks holda ma'lumotlar
# har bir qayta joylashtirishda (deploy) yo'qolib qoladi.
DB_PATH = os.getenv("DB_PATH", "speaking_bot.db")
